...
pattern!(
    TOKEN_VAR,
    "\\$(language|projectAlias|projectChannel|projectName|projectOwner|projectRoot|projectSource|projectType|project|target|taskPlatform|taskType|task|workspaceRoot|timestamp|datetime|date|time)"
);
pattern!(
    TOKEN_VAR_DISTINCT,
    "^\\$(language|projectAlias|projectChannel|projectName|projectOwner|projectRoot|projectSource|projectType|project|target|taskPlatform|taskType|task|workspaceRoot|timestamp|datetime|date|time)$"
