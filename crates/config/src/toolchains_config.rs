...
impl ToolchainsConfig {
    ...
    pub fn get_plugin_locator(id: &Id) -> Option<proto_core::PluginLocator> {
        ...
        match id.as_str() {
            ...
            "go" => Some(locate("go_toolchain", "1.1.0")),
            "javascript" => Some(locate("javascript_toolchain", "1.0.5")),
            ...
            "typescript" => Some(locate("typescript_toolchain", "1.1.0")),
            "unstable_python" => Some(locate("python_toolchain", "0.1.4")),
