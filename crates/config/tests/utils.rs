...
pub fn load_project_config_in_format(format: &str) {
    ...
    assert_eq!(
        ...
        ProjectConfig {
            ...
            env: FxHashMap::from_iter([("KEY".into(), Some("value".into()))]),
        ...
        TaskConfig {
            ...
            deps: Some(vec![
                ...
                TaskDependency::Config(TaskDependencyConfig {
                    ...
                    env: FxHashMap::from_iter([("DEBUG".into(), Some("1".to_owned()))]),
                    target: Target::parse("~:build").unwrap(),
                    optional: None
                }),
            ]),
        ...
        InheritedTasksConfig {
            ...
            implicit_deps: vec![
                ...
                TaskDependency::Config(TaskDependencyConfig {
                    ...
                    env: FxHashMap::from_iter([("KEY".into(), Some("value".to_owned()))]),
