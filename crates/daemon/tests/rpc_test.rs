// Integration test: spin up a real daemon server on a Unix socket,
// connect a client, and exercise every RPC method.

use moon_daemon::proto::moon_daemon_server::MoonDaemonServer;
use moon_daemon::*;
