...
package manager. While we're in the process of supporting additional languages, starting with Deno,
we had an idea... Since this is basically a better "version manager for tools", why not extract this
