...
we've only implemented [TOML plugins](/docs/proto/toml-plugin) in this release, and will implement
WASM plugins in a future release.
...
[TOML schema based plugin](/docs/proto/toml-plugin) as an alternative to a code based plugin. The
