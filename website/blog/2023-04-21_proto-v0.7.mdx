...
we've only implemented [TOML schema plugins](/docs/proto/plugins#toml-schema-plugin) in this
release, and will implement WASM plugins in a future release.
...
[TOML schema based plugin](/docs/proto/plugins#toml-schema-plugin) as an alternative to a code based
...
Learn more about [TOML schema plugins in the official docs](/docs/proto/plugins#toml-schema-plugin)!
