---
slug: moon-v1.3
title: moon v1.3 - Run advanced targets and an official proto plugin
authors: [milesj]
...
wasn't powerful enough, as it couldn't run the following scenarios:
...
[MQL, a unique query language](/docs/concepts/query-lang).
