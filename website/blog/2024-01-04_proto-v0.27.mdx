...
When our [TOML plugin](/docs/proto/toml-plugin) receives a version, we attempt to parse it into a
...
> Jump to the [official documentation](/docs/proto/toml-plugin#version-patterns) for more
> information!
