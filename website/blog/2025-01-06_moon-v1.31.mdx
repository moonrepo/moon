...
Happy new years everyone! In this release, we've landed a handful of quality-of-life improvements.
...
Before this release, you would need to explicitly list all targets, but with globs, you can achieve
