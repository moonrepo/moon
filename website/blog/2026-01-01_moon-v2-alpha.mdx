...
You can install the alpha with proto, or download it directly from the
[GitHub release page](https://github.com/moonrepo/moon/releases/tag/v2.0.0-alpha.2). We currently
aren't publishing the npm package.

```shell
$ proto install moon 2.0.0-alpha.4
```

> This requires proto v0.54.1 or later.
