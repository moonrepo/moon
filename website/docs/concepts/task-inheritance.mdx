...
where `*.yml` maps to a project based on a combination of its [language][language], [type][type], or
[tags][tags]. This enables you to easily declare tasks for "JavaScript projects", "Go applications",
...
[`platform`](../config/project#platform-1) to account for this:
...
- `.moon/tasks/tag-<name>.yml` <VersionLabel version="1.2.0" />
