...
File groups are also merged using these strategies, applied per group. Unlike tasks, the strategy is
configured per project with the
[`workspace.mergeStrategies.fileGroups`](../config/project#mergestrategies)
