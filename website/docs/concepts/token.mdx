...
Programming language the project is written in, as defined in [`project.yml`](../config/project). If
...
The type of project, as defined in [`project.yml`](../config/project). If the project has not
defined the [`type`](../config/project#type-1) setting, or does not have a config, this defaults to
"unknown".
...
The type of task that is currently running.
