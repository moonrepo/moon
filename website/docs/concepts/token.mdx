...
### `@group`<VersionLabel version="0.6" />
...
### `$language`<VersionLabel version="0.7" />
...
### `$projectType`<VersionLabel version="0.7" />

The type of project, as defined in [`moon.yml`](../config/project). If the project has not defined
the [`type`](../config/project#type-1) setting, or does not have a config, this defaults to
"unknown".
...
### `$taskType`<VersionLabel version="0.7" />
