...
`.moon/cache/pkl`, alongside the [JSON schemas](#schema-validation). A config that amends its module
...
amends "./cache/pkl/WorkspaceConfig.pkl"
```
...
extends "./cache/pkl/ExtensionsConfig.pkl"
```
...
extends "./cache/pkl/ToolchainsConfig.pkl"
```
...
amends "../cache/pkl/InheritedTasksConfig.pkl"
```
...
```pkl title="moon.pkl"
amends ".../.moon/cache/pkl/ProjectConfig.pkl"
```
...
amends ".../.moon/cache/pkl/TemplateConfig.pkl"
```
...
workspace uses `./.moon/cache/pkl/ProjectConfig.pkl` instead.

:::info

The modules are automatically created when running a task. If they do not exist yet, you can run
[`moon sync config-schemas`](../commands/sync/config-schemas) to generate them manually.
...
import ".../.moon/cache/pkl/TaskDependencyConfig.pkl"
