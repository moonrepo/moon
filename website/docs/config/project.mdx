...
Enables or disables [TypeScript support](./workspace#typescript) for this specific project.
Currently controls project reference syncing and `tsconfig.json` creation. Defaults to `true`.
