...
Configures the `Dockerfile` generation process when
[`moon docker file`](../commands/docker/file) is executed.
...
The Docker image to use in base stage. Defaults to `scratch`.
