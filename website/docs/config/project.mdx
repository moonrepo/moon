...
[sources skeleton](../commands/docker/scaffold#sources) (`.moon/docker/sources`).

#### `include`

<HeadingApiLink to="/api/types/interface/DockerScaffoldConfig#include" />

List of globs in which to copy project-relative files into the sources skeleton. When not defined,
defaults to `**/*`.
