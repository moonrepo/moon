...
paths via command line arguments. If there are no affected files, an argument of `.` (current
...
The list of files will also be passed as a comma separated list in the `MOON_AFFECTED_FILES`
