---
title: .moon/tasks.yml
---

import HeadingApiLink from '@site/src/components/Docs/HeadingApiLink';
import VersionLabel from '@site/src/components/Docs/VersionLabel';

The `.moon/tasks.yml` file (formerly `.moon/project.yml`) configures file groups and tasks that are
inherited by _every_ project in the workspace. Projects can override or merge with these settings
within their respective [`moon.yml`](./project). This file is _optional_.
