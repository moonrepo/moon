...
- Runtimes: [`unstable_bun`](#unstable_bun), [`unstable_node`](#unstable_node)
- Package managers: [`unstable_bun`](#unstable_bun), [`unstable_npm`](#unstable_npm),
  [`unstable_pnpm`](#unstable_pnpm), [`unstable_yarn`](#unstable_yarn)
...
`yarn`, or `bun`. Defaults to no package manager.
...
([`unstable_bun`](#unstable_bun), ([`unstable_node`](#unstable_node),
[`unstable_npm`](#unstable_npm), [`unstable_pnpm`](#unstable_pnpm), or
[`unstable_yarn`](#unstable_yarn)) to also be configured.
