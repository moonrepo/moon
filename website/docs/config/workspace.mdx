...
Defines a list of targets, with or without a project scope, that will be cached within the runner.
Tasks that produce [outputs](./project#outputs) are automatically cached, and do not need to be
defined here. Defaults to an empty list.
