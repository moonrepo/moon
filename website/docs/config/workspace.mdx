...
[workspace skeleton](../commands/docker/scaffold#workspace) (`.moon/docker/workspace`).
...
workspace skeleton. This is required for certain tools, like package managers, to work correctly.
...
List of globs in which to copy additional workspace-relative files into the workspace skeleton. When
