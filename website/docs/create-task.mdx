...
required, moon provides a feature known as [input groups](./concepts/input-group), which enables
grouping of similar file types within a project using
[file glob patterns or literal file paths](./concepts/file-pattern).

Input groups are defined with the [`inputGroups`](./config/project#inputgroups) setting, which maps
a list of file paths/globs to a group, like so.
...
We can then replace the inputs in our task above with these new input groups using a syntax known as
...
import FilegroupsBun from './__partials__/create-task/bun/inputgroups.mdx';
import FilegroupsDeno from './__partials__/create-task/deno/inputgroups.mdx';
import FilegroupsGo from './__partials__/create-task/go/inputgroups.mdx';
import FilegroupsNode from './__partials__/create-task/node/inputgroups.mdx';
import FilegroupsPHP from './__partials__/create-task/php/inputgroups.mdx';
import FilegroupsPython from './__partials__/create-task/python/inputgroups.mdx';
import FilegroupsRuby from './__partials__/create-task/ruby/inputgroups.mdx';
import FilegroupsRust from './__partials__/create-task/rust/inputgroups.mdx';
...
With input groups (and tokens), you're able to reduce the amount of configuration required _and_
