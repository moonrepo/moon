...
automatically generate a `CODEOWNERS` file by aggregating and syncing all project owners in the
workspace. The format and location of the `CODEOWNERS` file is based on the
