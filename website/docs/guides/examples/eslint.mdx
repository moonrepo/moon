...
<HeadingApiLink to="https://github.com/moonrepo/examples/blob/master/.moon/tasks.yml#L59" />
...
Since linting is a universal workflow, add a `lint` task to [`.moon/tasks.yml`](../../config/tasks)
