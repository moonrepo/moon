...
<HeadingApiLink to="https://github.com/moonrepo/examples/blob/master/.moon/tasks.yml#L83" />
...
Since testing is a universal workflow, add a `test` task to [`.moon/tasks.yml`](../../config/tasks)
