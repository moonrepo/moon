...
> Next.js has been prototyped in our
> [examples repository](https://github.com/moonrepo/examples/tree/master/apps/nextjs-app), check it
> out!
...
If you'd prefer to use the `next lint` command, add it as a task to the project's `project.yml`.
