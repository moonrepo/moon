...
If you already have a root `package.json`, jump to the
[installation instructions](#installing-the-cli), otherwise...
...
manager to execute the Rust binary, _instead of_ executing the Rust binary directly.
