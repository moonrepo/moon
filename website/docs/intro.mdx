...
- &nbsp;<Label text="Tier 1" variant="warning" /> &nbsp; **Project categorization** - Projects can
  configure their primary [language in `moon.*`](/docs/config/project#language), and have a
...
- &nbsp;<Label text="Tier 3" variant="success" /> &nbsp; **Toolchain integration** - Language is
  directly supported in the toolchain, configured in [`.moon/toolchains.*`](/docs/config/toolchain),
