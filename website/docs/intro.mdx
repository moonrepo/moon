...
- **Code ownership** <FeatureStatus status="new" /> - Declare owners, maintainers, support channels,
  and more. Generate CODEOWNERS.
...
- **Git hooks** <FeatureStatus status="new" /> - Manage Git hooks to enforce workflows and
