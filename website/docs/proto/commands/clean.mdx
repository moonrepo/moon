...
> Cleaning stale tools does _not_ remove records from [lockfiles](../config#unstable-lockfile), as
> the version may still be required by a configuration, or in use on other machines.
