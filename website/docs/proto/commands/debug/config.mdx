...
If [lockfiles](../../config#unstable-lockfile) are in use, `.protolock` files will be rendered
alongside their sibling configuration files. <VersionLabel version="0.60.0" />
