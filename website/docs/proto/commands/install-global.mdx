...
The `proto install-global <tool> <dependency>` (or `proto ig`) command will install a global
package/module/dependency for the provided tool.
...
- `<tool>` - Type of tool.
- `<dependency>` - Name of dependency and optional version.
