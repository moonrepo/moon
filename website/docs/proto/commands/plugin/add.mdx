...
> Tools in the official [community plugins](../../plugins#community-plugins) registry are resolved
> by ID, and do not need to be added. <VersionLabel version="0.62.0" inline />
