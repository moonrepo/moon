...
When a [lockfile](../config#unstable-lockfile) is in use, a "Locked" column will also be displayed,
showing the version locked for each configured specification. <VersionLabel version="0.60.0" />
