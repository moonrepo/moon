...
When enabled, we collect anonymous usage statistics for tool installs and uninstalls. This helps use
prioritize which tools to support, what tools or their versions may be broken, and the plugins
currently in use. Defaults to `true`.
