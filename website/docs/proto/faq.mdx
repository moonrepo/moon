...
Maybe... depends on the type of tool. We've received many asks for managing CLIs, like Stripe, but
it's still undecided on whether we'll support these first-class.
