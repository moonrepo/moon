...
the [`proto setup`](./proto/commands/setup) command, or add the path manually.

:::

## Supported tools

The following tools are [currently supported](./proto/tools) natively in proto. Additional tools can
be supported through [plugins](./proto/plugins).
