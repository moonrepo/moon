...
From here, we make these tools globally available by prepending `~/.proto/bin` to `PATH` (typically
as part of your shell profile). Continue reading for more about this bin folder.
