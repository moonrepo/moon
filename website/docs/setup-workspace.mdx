...
<NextSteps
	links={[
		{ label: 'Create a project', url: './create-project' },
		{ label: 'Configure `.moon/workspace.yml` further', url: './config/workspace' },
		{ label: 'Learn about the workspace', url: './concepts/workspace' },
		{ label: 'Learn about the toolchain', url: './concepts/toolchain' },
	]}
/>
